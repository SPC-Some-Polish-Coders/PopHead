...
namespace ph::system {
	...
	{
		auto view = mRegistry.view<component::PushingVelocity, component::KinematicCollisionBody, component::BodyRect>();
		view.each([dt](component::PushingVelocity& pushingVel, const component::KinematicCollisionBody kinematicCollisionBody, component::BodyRect& body)
		{
			// move body
