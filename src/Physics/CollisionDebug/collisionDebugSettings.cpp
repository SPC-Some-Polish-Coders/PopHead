...
{
	mShouldDisplay = true;
	PH_LOG(LogLevel::Info, "Collision debug was turned on.");
}

void CollisionDebugSettings::turnOff()
{
	mShouldDisplay = false;
	PH_LOG(LogLevel::Info, "Collision debug was turned off.");
}
...
void CollisionDebugSettings::displayOnlyKinematicBodies()
{
	...
	PH_LOG(LogLevel::Info, "Collision debug mode was changed. Now it should display only kinematic bodies.");
}
...
void CollisionDebugSettings::displayOnlyStaticBodies()
{
	...
	mShouldDisplayStaticBodies = true;
	PH_LOG(LogLevel::Info, "Collision debug mode was changed. Now it should display only static bodies.");
}
...
void CollisionDebugSettings::displayAllBodies()
{
	mShouldDisplayKinematicBodies = true;
	mShouldDisplayStaticBodies = true;
	PH_LOG(LogLevel::Info, "Collision debug mode was changed. Now it should display all bodies.");
}
...
void CollisionDebugSettings::setColors(int numberOfSet)
{
	...
	PH_LOG(LogLevel::Info, "Collision debug rect colors were set to " + std::to_string(numberOfSet) + ".");
}
