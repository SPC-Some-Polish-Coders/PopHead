...
{
public:
    explicit Scene(MusicPlayer&, SoundPlayer&, AIManager&, Terminal&, SceneManager&);
...
private:
	void initiateSystemsQueue(MusicPlayer&, SoundPlayer&, AIManager& aiManager, SceneManager& sceneManager);
