#define PH_JOYSTICK_A 0
#define PH_JOYSTICK_B 1
#define PH_JOYSTICK_X 2
...
#define PH_JOYSTICK_RT_LT sf::Joystick::Z
#define PH_JOYSTICK_DPAD_X sf::Joystick::PovX
#define PH_JOYSTICK_DPAD_Y sf::Joystick::PovY
